      ...
      <div class="col s4 sidebar side-nav fixed">
        ...
        <div id="div-all" class="col s12">
          <form class="col s10 offset-s1">
            <input class="form-search" type="text" placeholder="Cari seluruh layanan kesehatan...">
        ...
        <div id="div-apotek" class="col s12">
          <form class="col s10 offset-s1">
            <input class="form-search" type="text" placeholder="Cari apotek...">
            <i class="flaticon-magnifier52" style="margin-top: -51px; position: absolute; margin-left: -5px; color: #26a69a;"></i>
          </form>
          <br>
        ...
        <div id="div-rs" class="col s12">
          <form class="col s10 offset-s1">
            <input class="form-search" type="text" placeholder="Cari rumah sakit...">
            <i class="flaticon-magnifier52" style="margin-top: -51px; position: absolute; margin-left: -5px; color: #26a69a;"></i>
          </form>
        </div>
        <div id="div-klinik" class="col s12">
          <form class="col s10 offset-s1">
            <input class="form-search" type="text" placeholder="Cari klinik...">
            <i class="flaticon-magnifier52" style="margin-top: -51px; position: absolute; margin-left: -5px; color: #26a69a;"></i>
          </form>
        </div>
      </div>
